...
def select_product(id_produit, df_final_reduced,n_days) :
    ...
    df_final_train_singleProduct = df_final_train[df_final_train['unique_id'] == id_produit]
    df_final_test_singleProduct = df_final_test[df_final_test['unique_id'] == id_produit]
    df_final_singleProduct = df_final_reduced[df_final_reduced['unique_id'] == id_produit]
    return df_final_train_singleProduct, df_final_test_singleProduct, df_final_singleProduct